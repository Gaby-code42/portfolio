            ...
            <div className='footer__social'>
                ...
                <nav>
                    <ul className='reseaux'>
                       <li>
                            <a href="https://www.instagram.com/votre_profil" target="_blank" rel="noopener noreferrer" className="reseaux__link"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
                       </li>
                        <li>
                            <a href="https://www.linkedin.com/in/votre_profil" target="_blank" rel="noopener noreferrer" className="reseaux__link"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                        </li>
                        <li>
                            <a href="https://twitter.com/votre_profil" target="_blank" rel="noopener noreferrer" className="reseaux__link"><FontAwesomeIcon icon={faTwitter} size="2x" /></a>
                        </li>
                    </ul>
                </nav>
            </div>
