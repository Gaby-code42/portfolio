...
const Competence = () => {
    return(
                <div className='CompContainer'>
                    <h1 className='CompContainer__title'> Mes Compétences</h1>
                    <div className='CompContainer__htmlCss'>
                    <div className='CompContainer__subContainer'>
                ...
                <p>
                    ...
                    <img src={PngHtml} alt='logo html' className='CompContainer__img'></img>
                    </div>
                    <div className='CompContainer__javascript'>
                    <img src={PngJava} alt='logo java' className='CompContainer__img'></img>
                    <div className='CompContainer__subContainer'> 
                    ...
                    <div className='CompContainer__react'>
                    <div className='CompContainer__subContainer'>
                    <h2>React</h2>
                <p>
                    ...
                    <img src={PngReact} alt='logo react' className='CompContainer__img'></img>
        
                    </div>
                    <div className='CompContainer__nodeJs'>
                    <img src={PngNode} alt='logo node.js' className='CompContainer__img'></img>
                    <div className='CompContainer__subContainer'>
                ...
                <p>
                    ...
                    <div className='CompContainer__dev'>
                    <div className='CompContainer__subContainer'>
                ...
                <ul>
                    ...
                    <img src={PngDev} alt='logo node.js' className='CompContainer__img'></img>
                    </div>
